...
function customCheckColor(){
	...
	if (logoHeader === "dark" || logoHeader === "dark2") {
		$('.logo-header .navbar-brand').attr('src', 'styles_dashboard/assets/img/logo-white2.png');
	} else {
		$('.logo-header .navbar-brand').attr('src', 'styles_dashboard/assets/img/logo-black.png');
	}
}
