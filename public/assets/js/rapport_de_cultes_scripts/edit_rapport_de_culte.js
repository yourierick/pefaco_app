$(document).ready(function (){
    ...
    let countoffrande = parseInt(document.getElementById('lbl_count_don').innerHTML) + 1;
    let countautres = parseInt(document.getElementById('lbl_count_faits').innerHTML) + 1;
    $('#btn_add_reference').click(function() {
        ...
        input_reference.setAttribute('class', 'form-control mb-2');
        ...
        btn_sup.setAttribute('id', 'btn_remove_reference_'+ divcontainer.id);
        ...
        var element = "btn_remove_reference_" + divcontainer.id;
    ...
    $('#btn_add_special_offrande').click(function() {
        ...
        btn_sup.setAttribute('id', 'btn_remove_offrande_'+ divcontainer.id);
        ...
        var element = "btn_remove_offrande_" + divcontainer.id;
        var btnsup = document.getElementById(element);
    ...
    $('#btn_add_autres_faits').click(function() {
        ...
        btn_sup.setAttribute('id', 'btn_remove_autres_faits_'+ divcontainer.id);
        ...
        var element = "btn_remove_autres_faits_" + divcontainer.id;
        var btnsup = document.getElementById(element);
...
function deleteref(button){
    const parent = button.parentNode;
    parent.remove();
}

function deletedon(button){
    const parent = button.parentNode;
    parent.remove();
}

function deletefait(button){
    const parent = button.parentNode;
    parent.remove();
}
