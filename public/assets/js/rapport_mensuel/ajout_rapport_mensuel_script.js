$(document).ready(function (){
    let countprevisions = 1;
    let countrealisations = 1;
    let countprevisionsmoisprochain = 1;
    $('#btn_add_prevision_de_ce_mois').click(function() {
        ...
        divcontainer.setAttribute('id', 'div_prevision_'+countprevisions);
    ...
    $('#btn_add_realisations_pour_ce_mois').click(function() {
        ...
        divcontainer.setAttribute("class", "d-flex mb-0");
        divcontainer.setAttribute('id', 'div_realisation_'+countrealisations);
