$(document).ready(function (){
    ...
    $('#btn_communique').click(function() {
        let textarea = document.createElement('textarea');
        let btn_sup = document.createElement('button');
        let divcontainer = document.createElement('div');
        textarea.setAttribute('name', 'communique[]');
        textarea.setAttribute('placeholder', 'Entrez le communiqué');
        ...
        btn_sup.setAttribute('id', 'btn_remove_communique_'+ divcontainer.id);
        ...
        function deletecommunique(){
            divcontainer.remove();
        }
        var element = "btn_remove_communique_" + divcontainer.id;
        var btnsup = document.getElementById(element);
        btnsup.addEventListener("click", deletecommunique);
...
function deletecommunique(button){
