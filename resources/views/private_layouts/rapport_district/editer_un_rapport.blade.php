    ...
    <div class="py-12 mt-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg mb-3">
                <div class="max-w-xl">
                    <section>
                        <form method="post" action="{{ route('rapportdistrict.save_edition_rapport', $rapport->id) }}" class="mt-6 space-y-6">
                            <h3 class="mb-4">Editer ce rapport</h3>
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="text" name="zone" id="id_zone" value="{{ old('zone', $rapport->zone) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="text" name="paroisses_concernees" id="id_paroisses_concernees" value="{{ old('paroisses_concernees', $rapport->paroisses_concernees) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" type="text" placeholder="contexte" name="contexte" id="id_contexte">{{ old('contexte', $rapport->contexte) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="number" name="nombre_des_cultes_tenus" id="id_nbr_cultes_tenus" value="{{ old('nombre_des_cultes_tenus', $rapport->nombre_des_cultes_tenus) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="number" name="moyenne_de_frequentation" id="id_moyenne_de_frequentation" value="{{ old('moyenne_de_frequentation', $rapport->moyenne_de_frequentation) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="number" name="nombre_des_personnes_baptises" id="id_nbr_des_personnes_baptises" value="{{ old('nombre_des_personnes_baptises', $rapport->nombre_des_personnes_baptises) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="number" @if($current_user->id != $rapport->rapporteur_id) readonly @endif step="any" name="dime_des_dimes" id="id_dime_des_dimes" value="{{ old('dime_des_dimes', $rapport->dime_des_dimes) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" @if($current_user->id != $rapport->rapporteur_id) readonly @endif type="number" step="any" name="total_offrande" id="id_total_offrande" value="{{ old('total_offrande', $rapport->total_offrande) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" @if($current_user->id != $rapport->rapporteur_id) readonly @endif name="autres_contributions_a_renseigner" id="id_autres_contributions_a_renseigner">{{ old('autres_contributions_a_renseigner', $rapport->autres_contributions_a_renseigner) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control"  name="autres_evenements_a_rapporter" id="id_autres_evenements_a_rapporter">{{ old('autres_evenements_a_rapporter', $rapport->autres_evenements_a_rapporter) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" name="observation" id="id_observation">{{ old('observation', $rapport->observation) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" name="difficultes_defis" id="id_difficultes_defis">{{ old('difficultes_defis', $rapport->difficultes_defis) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" name="recommandations" id="id_recommandations">{{ old('recommandations', $rapport->recommandations) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" name="previsions_mois_prochain" id="id_previsions_mois_prochain">{{ old('previsions_mois_prochain', $rapport->previsions_mois_prochain) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" name="besoins_a_signaler" id="id_besoins_a_signaler">{{ old('besoins_a_signaler', $rapport->besoins_a_signaler) }}</textarea>
                                    <x-input-error class="mt-2 text-danger" :messages="$errors->get('besoins_a_signaler')"/>
                                </div>
                            </div>
                            <button class="btn btn-primary text-light" style="font-weight: normal" type="submit">Enregistrer les modifications</button>
                        </form>
                    </section>
                </div>
            </div>
