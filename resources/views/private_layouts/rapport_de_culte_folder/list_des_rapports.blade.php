...
@section('titre', '#Rapport de culte/liste des rapports')
@section("style")
    <style>
        .perso:hover{
            color: #000000;
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('rapportculte.supprimer_rapport') }}">
                        @csrf
                        @method('delete')
                            ...
                            <div class="tab-pane fade show active" id="orders-all" role="tabpanel"
                                ...
                                <div class="app-card app-card-orders-table shadow-sm mb-5">
                                    <div class="app-card-body table-responsive">
                                        <div>
                                            <table class="table table-responsive table-striped w-100" id="multi-filter-select">
                                                <thead style="text-transform: uppercase; background-color: #0a5a97; color: white">
                                                    <tr>
                                                        ...
                                                        <th class="cell" style="color: whitesmoke; font-weight: normal">Date</th>
                                                ...
                                                @foreach($rapports as $rapport)
                                                    <tr>
                                                        ...
                                                        <td class="cell" style="font-size: 10pt">{{ $rapport->date->format('d-m-Y') }}</td>
                                                        <td class="cell" style="font-size: 10pt">{{ $rapport->rapporteur }}</td>
                                                        <td class="cell" style="font-size: 10pt">{{ $rapport->statut }}</td>
                                                        <td class="cell" style="font-size: 10pt">{{ $rapport->audience }}</td>
                                                        <td class="cell">
                                                            <a class="btn-sm app-btn-secondary" href="{{ route('rapportculte.afficher_rapport_culte', $rapport->id) }}"><span class="bi-eye text-primary"></span></a>
                                                            @if($autorisation)
                                                                @if($autorisation->autorisation_en_ecriture)
