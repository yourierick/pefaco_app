    ...
    <div class="py-12 mt-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg shadow mb-3">
                <div class="max-w-xl">
                    <section>
                        <form method="post" id="my_form" action="{{ route('article.save_article') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button value="soumission" type="button" onclick="axiosprogressbar(this)" class="btn btn-primary mt-2 text-light">Soumettre</button>
                            <button value="draft" type="button" onclick="axiosprogressbar(this)" class="btn btn-primary mt-2 ml-2 text-light">Enregistrer comme draft</button>
                        </form>
                    </section>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        function axiosprogressbar(element) {
            ...
            axios.post('/article/save_article', formData, {
                headers: {
