                ...
                <div class="max-w-xl">
                    <section>
                        <form method="post" action="{{ route('horairehebdo.save_programmation', $horaire->id) }}" class="mt-6 space-y-6">
                            ...
                            <button type="submit" name="action" value="soumission"  class="btn btn-primary mt-2 text-light">soumettre</button>
                            <button type="submit" name="action" value="nouvel_enregistrement" class="btn btn-primary mt-2 text-light">soumettre et enregistrer à nouveau</button>
                        </form>
                    </section>
                </div>
            </div>
