    ...
    <div class="py-12 mt-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg shadow mb-3">
                <div class="max-w-xl">
                    <section>
                        <form method="post" action="{{ route('rapportinspection.sauvegarder_le_rapport') }}" class="mt-6 space-y-6">
                            @csrf
                            <h3 class="mb-2">Faire un nouveau rapport</h3>
                            <input class="form-control" type="hidden" name="rapporteur_id" id="id_rapporteur" value="{{ old('rapporteur_id', $current_user->id) }}">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <input class="form-control" type="text" placeholder="paroisses concernées" name="paroisses_concernees" id="id_paroisses_concernees" value="{{ old('paroisses_concernees') }}">
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea name="contexte" class="form-control" placeholder="contexte" id="id_contexte" rows="3">{{ old('contexte') }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea name="constats" class="form-control" placeholder="constats" id="id_constats" rows="3">{{ old('constats') }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea name="conclusions" class="form-control" placeholder="vos conclusions" id="id_conclusions" rows="3">{{ old('conclusions') }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea name="difficultes_rencontrees" placeholder="difficultés rencontrées" class="form-control" id="id_difficultes_rencontrees" rows="3">{{ old('difficultes_rencontrees') }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-group-kaiadmin form-group-default-kaiadmin">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="récommandations" name="recommandations" id="id_recommandations">{{ old('recommandations') }}</textarea>
                                    <x-input-error class="mt-2 text-danger" :messages="$errors->get('recommandations')"/>
                                </div>
                            </div>
                        
                            <button name="action" value="draft" class="btn btn-secondary mt-2 text-light" type="submit">Enregistrer le draft</button>
                            <button name="action" value="soumission_validation" class="btn btn-primary mt-2 text-light" type="submit">Soumettre pour validation</button>
                        </form>
                    </section>
                </div>
            </div>
